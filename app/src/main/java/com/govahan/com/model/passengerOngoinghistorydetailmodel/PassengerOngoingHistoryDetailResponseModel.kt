...
data class PassengerOngoingHistoryDetailResponseModel (
    ...
    @SerializedName("ownerDetails" ) var ownerDetails : OngoingPassengerHistoryOwnerDetails?   = OngoingPassengerHistoryOwnerDetails(),
    @SerializedName("userDetails"  ) var userDetails  : OngoingPassengerHistoryUserDetails?    = OngoingPassengerHistoryUserDetails()
...
data class OngoingPassengerHistoryOwnerDetails (
...
data class OngoingPassengerHistoryUserDetails (
